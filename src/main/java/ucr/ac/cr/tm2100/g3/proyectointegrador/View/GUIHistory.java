...
public class GUIHistory extends javax.swing.JFrame {
     ...
     */
    public GUIHistory(GameController controller) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnOut.setActionCommand("OutHistory");
        btnOut.setBorderPainted(false);
        btnOut.setContentAreaFilled(false);
        getContentPane().add(btnOut, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 880, -1, -1));
